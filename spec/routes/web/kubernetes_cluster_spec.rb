  ...
  describe "authenticated" do
    ...
    describe "upgrade" do
      it "shows upgrade button when upgrade is available and cluster is ready" do
        ...
        expect(page).to have_content "will be upgraded to version"
        expect(page).to have_content "v1.34"
      ...
      it "can upgrade kubernetes cluster" do
        ...
        expect(page).to have_flash_notice("myk8s will be upgraded to v1.34")
        expect(kc.reload.version).to eq("v1.34")
